...
SECRET_KEY = 'django-insecure-w#de4(c@j(dl$s^@^498h)k)nh_dni)af@8z*+bjll!u^0a-v2'
...
LANGUAGE_CODE = 'en-us'
#jei įrašysime 'lt', bus lietuviškai:
#LANGUAGE_CODE = 'lt'
LANGUAGES = (
    ('en-us', _('English')),
    ('lt', _('Lithuanian')),
...
#žemiau esantis aprašymas leidžia formatuoti tekstą aprašymuose
#admin puslapyje
